...
(
    ...
    remark      VARCHAR(500),
    CONSTRAINT param_key_unique UNIQUE (param_key)
);
...
(
    appid    CHAR(20)    NOT NULL PRIMARY KEY,
...
(
    ...
    msg_type    CHAR(25)    NULL DEFAULT NULL,
    detail      OTHER       NULL,
...
CREATE INDEX idx_status ON wx_msg_template (status);
CREATE INDEX idx_appid ON wx_msg_template (appid);
